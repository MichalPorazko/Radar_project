...
case class Polyphase_filter_parameters()

class Polyphase_filter_pipe(parameters: Polyphase_filter_parameters) extends Module{


}


object Polyphase_filter_pipe extends App{
